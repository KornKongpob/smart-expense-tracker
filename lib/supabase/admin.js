...
export function getSupabaseServerConfig() {
  return {
    url: getEnv("SUPABASE_URL", "NEXT_PUBLIC_SUPABASE_URL") || getEnv("VITE_SUPABASE_URL"),
    anonKey: getEnv("SUPABASE_ANON_KEY", "NEXT_PUBLIC_SUPABASE_ANON_KEY") || getEnv("VITE_SUPABASE_ANON_KEY"),
